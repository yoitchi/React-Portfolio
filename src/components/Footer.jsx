...
function Footer() {
  return (
    <footer className="footer--container">
      <p className="footer--content">2025 John Bladimir. All rights reserved.</p>
      <div className="footer--social--icon">
        <ul>
          <li>
            <a
              href="https://www.facebook.com/profile.php?id=10007248725407" // Replace with your Facebook URL
          ...
          <li>
            <a
              href="https://www.instagram.com/yoitchi_/" // Replace with your Instagram URL
              className="navbar--content"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://github.com/yoitchi" // Replace with your GitHub URL
              className="navbar--content"
              target="_blank"
              rel="noreferrer"
            >
              ...
              >
                <path
                  d="M12 0C5.37 0 0 5.37 0 12C0 17.31 3.435 21.795 8.205 23.385C8.805 23.49 9.03 23.13 9.03 22.815C9.03 22.53 9.015 21.675 9.015 20.775C6 21.375 5.34 19.74 5.34 19.74C4.83 18.48 4.095 18.12 4.095 18.12C3.12 17.505 4.155 17.52 4.155 17.52C5.22 17.595 5.775 18.63 5.775 18.63C6.72 20.235 8.265 19.8 9.06 19.485C9.18 18.855 9.465 18.405 9.78 18.12C7.14 17.835 4.38 16.905 4.38 12.405C4.38 11.025 4.875 9.885 5.685 8.985C5.55 8.7 5.085 7.41 5.73 5.73C5.73 5.73 6.63 5.43 9.015 6.795C9.87 6.54 10.875 6.405 11.88 6.405C12.885 6.405 13.89 6.54 14.745 6.795C17.13 5.43 18.03 5.73 18.03 5.73C18.675 7.41 18.21 8.7 18.075 8.985C18.885 9.885 19.38 11.025 19.38 12.405C19.38 16.92 16.62 17.835 13.965 18.12C14.37 18.48 14.73 19.2 14.73 20.28C14.73 21.765 14.715 22.44 14.715 22.815C14.715 23.13 14.94 23.505 15.555 23.385C20.565 21.795 24 17.31 24 12C24 5.37 18.63 0 12 0Z"
                  fill="black"
                />
              </svg>
            </a>
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/yoitchi-hiruma-185600359/" // Replace with your LinkedIn URL
              className="navbar--content"
              target="_blank"
              rel="noreferrer"
            >
